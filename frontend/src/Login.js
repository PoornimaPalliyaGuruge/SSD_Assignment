...
const Login = () => {
    ...
    //         });
    //
    //         // Parse the response as JSON to access message and status
    //         const data = await response.json();
    //
    //         if (response.ok) {
    //             console.log("Login successful");
    ...
    //         } else if (response.status === 429) {
    //             // Handle too many requests error (rate limit)
    //             setError("Too many requests. Please try again later."); // Display proper message in UI
    //         } else {
    //             // For other errors, use the message provided by the API or a fallback message
    //             setError(data.message || "Login failed. Check your credentials.");
    //         }
    //     } catch (error) {
    //         // Catch any unexpected errors (like network issues) and display them
    //         console.error("Error:", error);
    //         setError("An error occurred during login. Please try again.");
    //     }
    // };
